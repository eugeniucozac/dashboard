...
describe('FORMS › EditPolicy', () => {
  ...
  describe('@render', () => {
    it('renders without crashing', () => {
      // arrange
      const { container } = render(<EditPolicy {...props} />);
    ...
    it('renders the form', () => {
      // arrange
      const { getByTestId } = render(<EditPolicy {...props} />);

      // assert
      expect(getByTestId('form-edit-policy')).toBeInTheDocument();
    });

    it('renders the form buttons', () => {
      // arrange
      const { queryByText } = render(<EditPolicy {...props} />);
    ...
    it('renders the form inputs', () => {
      // arrange
      const { container, getByText, getByLabelText } = render(<EditPolicy {...props} />);
